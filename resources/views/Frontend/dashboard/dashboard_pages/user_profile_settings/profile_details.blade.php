            ...
            <div class="col-md-8">
                <div class="card bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.profiledetails.update') }}" method="POST" enctype="multipart/form-data">
                            @method("PUT")
                            @csrf
                            <div class="row">
                                ...
                                {{-- <div class="col-md-12 text-center">
                                    ...
                                    <img  src="{{asset($user->profile_photo_path)}}" class="rounded-circle " style="width:100px;height:100px">
                                    @endif
