<div class="header-area">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 col-sm-4 clearfix">
            <ul class="notification-area pull-right my-1">
                <li>
                    <a class="btn btn-dark btn-sm" href="{{ url('admin/logout') }}"> <i class="fa fa-arrow-left mr-2" aria-hidden="true"></i> Log Out</a>
                </li>
