                ...
                <div class="card bg-dark">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                              <h3 class="text-white">Create Branch</h3>
                              <a class="btn btn-success btn-sm" href="{{ route('admin.footer_settings.index') }}">Back</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.footer_settings.store') }}" method="post" class="form">
                            @include('Backend.layout.partials.messages')
                            @csrf
                            <div class="form-group">
                                <label class="text-white" for="">Branch Name</label>
                                <input value="{{ old('name') }}" class="form-control" type="text" name="name" id="" placeholder="Branch Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="6" placeholder="Branch Address" name="description" class="form-control">{{ old('description') }}</textarea>
                            </div>
                            <input class="btn btn-success" type="submit" value="Add Branch">
                        </form>
                    </div>
                </div>
            </div>
